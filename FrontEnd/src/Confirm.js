          ...
          <div className="container">
            ...
            <div className="collapse navbar-collapse" id="myNavbar1">
              <ul className="nav navbar-nav navbar-right navbar-search-link">
                <li className="dropdown"><Link to={{pathname:'/home', state:this.props.location.state}}  className="dropdown-toggle" data-toggle="dropdown">Home<span></span></Link>
                  	
                </li>
                <li className="dropdown"><Link to={{pathname:'/flighthome', state:this.props.location.state}}  className="dropdown-toggle" data-toggle="dropdown">Flights<span></span></Link>
                ...
                <div className="col-xs-12 col-sm-12 col-md-9 col-lg-9 content-side">
                  <div className="space-right">
                    <div className="thank-you-note">
                      <h3>Your information is confirmed now. Thank You!</h3>
                      <p></p>
